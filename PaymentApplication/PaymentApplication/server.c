...
ST_accountsDB_t accountsDB[255] =
{
	...
	{254.0, RUNNING, "6964690405822411"},//blocked
...
void recieveTransactionDataTest(void)
{
	...
	transData = (ST_transaction_t){ .cardHolderData = "AbdelrahmanMohamedHekal ","1254745632147452","11/27",.terminalData = {150,1500,"17/11/2022"} };
	printf("Input Data: cardHolderData = {AbdelrahmanMohamedHekal ,1254745632147452,11/27},\nterminalData = {150,1500,17/11/ 2022} \n");
	printf("Expected Result: 3  (FRAUD_CARD) \n");
	printf("Actual Result: %d \n", recieveTransactionData(&transData));
	printf("#######################################################\n");
	printf("Test Case 2: stolen card (Account blocked)\n");
	transData = (ST_transaction_t){ .cardHolderData = "AbdelrahmanMohamedHekal ","2010377165328481","11/27",.terminalData = {150,1500,"17/11/2022"} };
	printf("Input Data: cardHolderData = {AbdelrahmanMohamedHekal ,2010377165328481,11/27},\nterminalData = {150,1500,17/11/2022} \n");
	printf("Expected Result: 2  (DECLINED_STOLEN_CARD) \n");
	printf("Actual Result: %d \n", recieveTransactionData(&transData));
	printf("#######################################################\n");
	printf("Test Case 3: Insufficiend fund\n");
	transData = (ST_transaction_t){ .cardHolderData = "AbdelrahmanMohamedHekal ","6964690405822411","11/27",.terminalData = {900,1500,"17/11/2022"} };
	printf("Input Data: cardHolderData = {AbdelrahmanMohamedHekal,2010377165328481,11/27},\nterminalData = {150,1500,17/11/2022} \n");
	printf("Expected Result: 1  (DECLINED_INSUFFECIENT_FUND) \n");
	printf("Actual Result: %d \n", recieveTransactionData(&transData));
	printf("#######################################################\n");
	printf("Test Case 4: Approved \n");
	transData = (ST_transaction_t){ .cardHolderData = "AbdelrahmanMohamedHekal","6964690405822411","11/27",.terminalData = {120,1500,"17/11/2022"} };
	printf("Input Data: cardHolderData = {AbdelrahmanMohamedHekal ,2010377165328481,11/27},\nterminalData = {150,1500,17/11/2022} \n");
...
void isValidAccountTest(void)
{
	...
	cardData = (ST_cardData_t){ .cardHolderName = "AbdelrahmanMohamedHekal",.primaryAccountNumber = "1236541265474145",.cardExpirationDate = "11/27" };
	printf("Input Data: cardHolderName=AbdelrahmanMohamedHekal,primaryAccountNumber=1236541265474145,cardExpirationDate=11/27\n");
	...
	cardData = (ST_cardData_t){ .cardHolderName = "AbdelrahmanMohamedHekal",.primaryAccountNumber = "6964690405822411",.cardExpirationDate = "11/27" };
	printf("Input Data: cardHolder=AbdelrahmanMohamedHekal,primaryAccountNumber=6964690405822411,cardExpirationDate=11/27\n");
...
void isAmountAvailableTest(void)
{
	...
	termData = (ST_terminalData_t){ .transAmount = 400,.maxTransAmount = 1500,.transactionDate = "17/11/2022" };
	printf("Input Data: Account Balance =120.0, transAmount = 400.0\n");
	...
	termData = (ST_terminalData_t){ .transAmount = 400,.maxTransAmount = 1500,.transactionDate = "17/11/2022" };
	printf("Input Data: Account Balance =12345.0, transAmount = 400.0\n");
	printf("Expected Result: 0  (SERVER_OK) \n");
	printf("Actual Result: %d \n", isAmountAvailable(&termData, accountRefrence));
	printf("#######################################################\n");
...
void saveTransactionTest(void)
{
	...
	{ .cardHolderData = {.cardHolderName = "AbdelrahmanMohamedHekal",.cardExpirationDate = "11/27",.primaryAccountNumber = "9737628650334429"}
	 ,.terminalData = {.maxTransAmount = 4000,.transactionDate = "17/11/2022",.transAmount = 150}
	 ,.transState = APPROVED
	};
	printf("Input Data: .cardHolderData = {.cardHolderName =AbdelrahmanMohamedHekal,.cardExpirationDate = 11/ 27,.primaryAccountNumber = 9737628650334429}\nterminalData = { maxTransAmount = 4000transactionDate = 17/11/2022transAmount = 150 }\ntransactionSequenceNumber = 0, .transState = APPROVED);\n");
	printf("Expected Result: 0  (SERVER_OK) \n");
	printf("Actual Result: %d \n", saveTransaction(&transData));
	printf("#######################################################\n");
	...
	printf("Input Data: .cardHolderData = {.cardHolderName = AbdelrahmanMohamedHekal,.cardExpirationDate = 10 / 27,.primaryAccountNumber = 9737628650334429}\nterminalData = { maxTransAmount = 4000transactionDate = 17/11/2022transAmount = 150 }\ntransactionSequenceNumber = 0, .transState = FRAUD_CARD);\n");
	printf("Expected Result: 0  (SERVER_OK) \n");
	printf("Actual Result: %d \n", saveTransaction(&transData));
	printf("#######################################################\n");
}
